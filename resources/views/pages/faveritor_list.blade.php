...
<tbody>
    <?php $i=0 ?>
    @foreach ( App\Http\Controllers\home_controller::show_favorited_list() as $data )
{{-- @dd($data) --}}
...
{{-- <td>
    <a href="/delete_favorite/{{$data->favorite_id}}" class="text-center data-delete" data-id="3318"><i class="fa fa-trash text-danger"></i></a>
</td> --}}
</tr>
@endforeach
</tbody>
