...
<input type="text"  class="form-control" onblur="handle_birth_day(this);" onfocus="handle_birth_day(this);"  name="date_of_birth" id="date_of_birth" value="@if($primary_info != null)<?php  $date=date_create($primary_info->date_of_birth); ?>{{date_format($date,"m/d/Y")}}@endif" placeholder = "mm/dd/yyyy">
