            ...
            <table class="table align-middle w-100 table-stripped justify-content-center text-center">
             ...
             <tr>
               ...
               <!--- total_package -->
                ...
                <h5> আপনার  {{(int)$total_package[0]->total - $purchased_count}}  টি কানেকশন অবশিষ্ট আছে । </h5>
                <a href="{{URL::to("/package_connection_buy_add?biodata_id=$biodata_id")}}" class="btn btn-success">Ok</a>
                 <!--- // else total_package -->
                @else
