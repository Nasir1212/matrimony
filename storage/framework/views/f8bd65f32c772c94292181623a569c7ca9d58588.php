<?php $auth =  App\Models\Register::where(['mail'=>session()->get('email')])->get()[0] ?>
    ...
    <a href="/show_biodata/<?php echo e($auth->id); ?>" target="_blank" class="btn btn-primary btn-block btn-sm">বায়োডাটা দেখুন</a>
    </div>
<?php /**PATH C:\Nasir All Project\Nasir_Personal_Project\Ordangini\resources\views/component/profile_card.blade.php ENDPATH**/ ?>