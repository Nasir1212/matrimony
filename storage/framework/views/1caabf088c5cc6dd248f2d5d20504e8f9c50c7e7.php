...
<h2>
বায়োডাটা সমূহ
<?php if(isset($searching_data)): ?>
<p class="mt-3 text-white count-biodata-found">মোট বায়োডাটা সমূহ : <?php echo e(count($searching_data)); ?></p>
...
<?php if(isset($searching_data) && count($searching_data) >0): ?>
<?php $__currentLoopData = $searching_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<p><?php echo e($data->marid_type); ?></p>
<label>বর্তমান ঠিকানা </label>
<p><?php echo e($data->present_address); ?></p>
<label>জন্মসন (আসল) </label>
<p><?php echo e($data->birth); ?></p>
<label>পেশা</label>
<p><?php echo e($data->profession); ?></p>
</div>
<div class="biodata-footer align-items-middle align-self-middle text-center m-auto">
<a href="<?php echo e(URL::to("/show_biodata/$data->user_table_id")); ?>" class="btn btn-primary">বায়োডাটা দেখুন</a>
<a onclick="add_favorite('<?php echo e($data->user_table_id); ?>');" class="btn btn-outline-primary btn-favorite"><i class="fa fa-heart-o"></i></a>
</div>
</div>
</div>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("master.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Nasir All Project\Nasir_Personal_Project\Ordangini\resources\views/pages/search_biodata.blade.php ENDPATH**/ ?>