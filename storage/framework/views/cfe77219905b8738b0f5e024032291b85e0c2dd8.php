...
<tbody>
    <?php $i=0 ?>
    <?php $__currentLoopData = App\Http\Controllers\home_controller::show_favorited_list(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make("master.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ordhang1/public_html/resources/views/pages/faveritor_list.blade.php ENDPATH**/ ?>