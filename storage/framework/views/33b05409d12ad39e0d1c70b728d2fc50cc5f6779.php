...
<section class="login-section">
    ...
    <a class="float-right" href="<?php echo e(URL::to("/reset_password")); ?>">পাসওয়ার্ড ভুলে গেছেন?</a>
    </div>
    </div>
    <div class="col-xl-12">
...
$authUrl = $end_point.'?'.http_build_query([
    ...
    ?>
    <a href="<?php echo e($authUrl); ?>"><i class="fa fa-google"></i> Google</a>
    </div>
...
<?php echo $__env->make("master.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Nasir All Project\Nasir_Personal_Project\Ordangini\resources\views/pages/login.blade.php ENDPATH**/ ?>