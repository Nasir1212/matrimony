...
<?php
    $is_enable = App\Models\PopUpModel::first()->disable_enable;
?>
<?php if(  $is_enable == 'anable'): ?>
<?php $__env->startComponent("component.popup"); ?>  <?php echo $__env->renderComponent(); ?>  
<?php endif; ?>
<?php dd(env("BKASH_APP_KEY")); ?>
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-9">
                <div class="recent-item">
                    <ul>
                        ...
                        <?php $__currentLoopData = App\Http\Controllers\home_controller::latest_biodata(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $biodata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="/show_biodata/<?php echo e($biodata->user_table_id); ?>" target="_blank">
                                <div class="recent-item-register justify-content-center align-items-center align-self-middle d-inline-block">
                                    ...
                                    <div class="recent-reigster-item d-inline-block text-center">
                                        <h4>বায়োডাটা নাম</h4>
                                        <p class="m-0"> <?php echo e($biodata->user_name); ?></p>
                                    </div>
                                </div>
                            </a>
                        </li>
...
<option value="বিপত্নীক">বিপত্নীক</option>
                        ...
                        <div class="form-row mb-2">
                            ...
                            <select class="form-control col-xl-4 form-control-sm col-md-8 min_age" name="minimumages" data-placeholder="বয়স">
                                <?php for($x = 18; $x <= 75; $x++): ?>
                                <option value="<?php echo e($x); ?>"  <?php if($x==18): ?> selected="&quot;selected&quot;" <?php endif; ?>><?php echo e($x); ?></option>  
                                <?php endfor; ?>
</select>
...
<select class="form-control col-xl-4 form-control-sm col-md-8 max_age" name="maximumages" data-placeholder="বয়স">
    ...
    <?php for($x = 18; $x <= 75; $x++): ?>
    <option value="<?php echo e($x); ?>" <?php if($x==22): ?> selected="&quot;selected&quot;" <?php endif; ?>><?php echo e($x); ?></option>  
    <?php endfor; ?>
</select>
                        </div>
                        <div class="form-row mb-2">
...
<?php $__currentLoopData = App\Http\Controllers\home_controller::show_random_biodata(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $biodata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="col-xl-4 col-md-6 wow fadeInUp animated" data-wow-delay="0.2s">
                <div class="biodata-card">
                    ...
                    <div class="biodata-body">
                        ...
                        <p><?php echo e($biodata->present_address); ?></p>
...
<span class="text-white" aria-hidden="true">&times;</span>
            ...
            <div class="modal-body p-0">
                <iframe width="100%" height="400" src="https://www.youtube.com/embed/2ggn1d8NUTs?si=FefNW2lU6PaAhDDN" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
    </div>
</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("master.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Nasir All Project\Nasir_Personal_Project\Ordangini\resources\views/pages/home.blade.php ENDPATH**/ ?>